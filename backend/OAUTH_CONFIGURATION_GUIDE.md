...
Make sure your `.env` file includes the correct URLs:
...
Facebook: https://api.prism-app.com/auth/facebook/callback
Instagram: https://api.prism-app.com/auth/instagram/callback
TikTok: https://api.prism-app.com/auth/tiktok/callback
YouTube: https://api.prism-app.com/auth/youtube/callback
Threads: https://api.prism-app.com/auth/threads/callback
```

### Staging Environment
```
Google: https://staging.prism-app.com/auth/google/callback
Twitter: https://staging.prism-app.com/auth/twitter/callback
LinkedIn: https://staging.prism-app.com/auth/linkedin/callback
Facebook: https://staging.prism-app.com/auth/facebook/callback
Instagram: https://staging.prism-app.com/auth/instagram/callback
TikTok: https://staging.prism-app.com/auth/tiktok/callback
YouTube: https://staging.prism-app.com/auth/youtube/callback
Threads: https://staging.prism-app.com/auth/threads/callback
```
...
2. **Test each OAuth provider**:
   - Navigate to `https://prism-app.com/login`
...
5. Make sure both production and staging URLs are configured if using both environments
...
4. Verify the correct app is being used for each environment
...
4. Verify both production and staging certificates are valid
...
- Ensure apps are published/approved
- Use strict CORS settings
- Monitor for security issues

### Staging Environment
- Can use development/testing OAuth credentials
- More permissive CORS settings allowed
- Useful for testing new features
- Should mirror production configuration

### Local Development
- Use localhost URLs (http://localhost:3000)
- Separate OAuth app credentials recommended
