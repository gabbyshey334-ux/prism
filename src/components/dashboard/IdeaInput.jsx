...
const ContentCreationWorkflow = ({ initialIdea, onClose, onComplete, skipToGeneration }) => {
  ...
  const handleFormatSelect = (format) => {
    ...
    toast.info(`Starting workflow for: "${initialIdea?.ai_generated_title}" in ${format} format.`);
    // Simulate content generation or navigate to content creation page
    setTimeout(() => {
      onComplete(); // Call onComplete after simulated work
      ...
      >
        ...
        <div className="py-4">
          <p className="text-sm text-gray-600 mb-4">
            Select a format to start generating content for this idea.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Button
              variant="outline"
              className="h-24 flex flex-col items-center justify-center gap-1 text-base"
              onClick={() => handleFormatSelect('Blog Post')}
            >
            ...
            <Button
              variant="outline"
              className="h-24 flex flex-col items-center justify-center gap-1 text-base"
              onClick={() => handleFormatSelect('Tweet Thread')}
            >
            ...
            <Button
              variant="outline"
              className="h-24 flex flex-col items-center justify-center gap-1 text-base"
              onClick={() => handleFormatSelect('Video Script')}
            >
            ...
            <Button
              variant="outline"
              className="h-24 flex flex-col items-center justify-center gap-1 text-base"
              onClick={() => handleFormatSelect('Instagram Carousel')}
            >
